...
def main():
    ...
    if handoff:
        sys.stderr.write(
            ...
            "rule 11 event-driven specification gate (a NEW task awaiting its work-spec or an "
            "applicable development-spec approval before execution — those approvals are the user's and this check never "
            "overrides them), the "
