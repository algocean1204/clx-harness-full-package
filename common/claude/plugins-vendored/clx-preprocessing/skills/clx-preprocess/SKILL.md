---
name: clx-preprocess
description: Cluxion preprocessing for clarification, queueing, loop_auto, doctor checks, or surface-specific JSON contracts. Load autonomously when preprocessing genuinely helps — fuzzy or multi-item intake, queued work bundles, broken-loop diagnosis — or on explicit /preprocess. Skip when the task is already precise.
---
