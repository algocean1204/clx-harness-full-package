---
name: clx-unslop
description: "Post-process AI-generated text through the unslop CLI to strip AI writing patterns before publishing. Use when the user wants to remove AI-sounding phrasing / slop from text before publishing (AI티 나는 글 다듬기, 슬롭 제거, 자연스럽게 다듬어)."
license: "MIT"
metadata:
  category: writing
  risk: safe
...
# clx-unslop — Strip AI Writing Patterns via CLI
