...
PWCLI=""
for f in \
  "$HOME"/.claude/skills/clx-playwright/scripts/playwright_cli.sh \
  "$HOME"/.codex/skills/clx-playwright/scripts/playwright_cli.sh \
  "$HOME"/.codex/skills-disabled/clx-playwright/scripts/playwright_cli.sh
do
  [ -x "$f" ] && PWCLI="$f" && break
done
export PWCLI
